...
public class Registry {
    ...
    // BlockItem Registry
    public static final RegistryObject<BlockItem> CHOCOLATE_CAKE_ITEM = ITEMS.register("chocolate_cake", () -> new BlockItem(CHOCOLATE_CAKE.get(), new Item.Properties())); 


    // ! ITEM REGISTRY
    // Ice Creams
    // TODO: Currently they're items for test purposes
    public static final RegistryObject<Item> VANILLA_ICE_CREAM = ITEMS.register("ice_cream", () -> new Item(new Item.Properties()));
